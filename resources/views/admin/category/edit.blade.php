                                ...
                                <div class="card-body">
                                    <form action="{{ route('Admin.Update.Category',$category->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group my-3">
                                            ...
                                            <input type="text" name="category_slug" value="{{ $category->category_slug }}" class="form-control" placeholder="Enter Category Slug">
                                        </div>
                                        <div class="form-group my-3">
                                            <label for="" class="mb-1 ml-2">Category Description</label>
                                            <input type="text" name="category_des" value="{{ $category->category_des }}" class="form-control">
                                        </div>
                                        <div class="form-group my-3">
                                        ...
                                        <div class="form-group mb-3">
                                            <img src="{{ asset('images/'.$category->category_img) }}" height="180px" width="180px" alt="{{ $category->image }}">
                                        </div>
